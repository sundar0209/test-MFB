...
const WeeklyViewCustomer = (props) => {
   ...
   const customerlist = () => {
      ...
      axiosObject.post("customer/condition", request)
         ...
         .then((response) => {
            ...
            setPincode(response.data.data[0]?.pin_code == 0 ? "" : response.data.data[0]?.pin_code)
            ...
            <section id="content-wrapper">
               <div className="row">
                  ...
                  <div className="col-12 col-lg-4 col-md-4 col-sm-4 save-back">
                     <Link to="/weeklycustomers" className="btn btn-primary btn-outline float-end"><i class="fa-solid fa-arrow-left"></i> <span className='label'>Back</span></Link> <button onClick={() => editCustomer(custID)} type="submit" className="btn btn-primary float-end"><i className="fa fa-pencil"></i><span className='label'> Edit</span></button>
                  </div>
                        ...
                        <div class="card viewCustomerDetails">
                           <div class="card-body">
                              ...
                              <div class="row mt-3">
                                 ...
                                 <div class="col-xxl-4 col-md-6">
                                    <p className="form-label">Another Name</p>
                                    <p className='form-value'>{AnothercustName}</p>
                                 </div>
                                 <div class="col-xxl-4 col-md-6">
                                 ...
                                 <div class="col-xxl-4 col-md-6">
                                    <p className="form-label">AdharNumber</p>
                                    <p className='form-value'>{AdharCardNumber}</p>
                                 </div>
                                 <div class="col-xxl-4 col-md-6">
                                    <p className="form-label">Street</p>
                                    <p className='form-value'>{Street}</p>
                                 </div>
                                 <div class="col-xxl-4 col-md-6">
                                    <p className="form-label">Village</p>
                                    <p className='form-value'>{Village}</p>
                                 </div>
                                 <div class="col-xxl-4 col-md-6">
                                    <p className="form-label">Pin_code</p>
                                    <p className='form-value'>{Pincode}</p>
                                 </div>
                                 <div class="col-xxl-4 col-md-6">
                                    <p className="form-label">Area</p>
                                    <p className='form-value'>{Area}</p>
                                 </div>
                                 <div class="col-xxl-4 col-md-6">
                                    <p className="form-label">AccountNumber</p>
                                    <p className='form-value'>{CustaccountNumber}</p>
                                 </div>
                                 <div class="col-xxl-4 col-md-6">
...
export default WeeklyViewCustomer;
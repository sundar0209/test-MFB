...
const WeeklyReports = () => {
  ...
  const getCustData = () => {
    ...
    axiosObject
      .post("reports/condition", request)
  ...
  const searchCollectionDetail = (data) => {
    ...
    let request = {
      start_date: FromDate == null ? "" : FromDate,
      end_date: ToDate == null ? "" : ToDate,
      status: statuss,
      status1: "",
      status2: loanstatus,
    ...
    axiosObject.post("reportsSearch/condition", request)
      .then((response) => {
        ...
        <section id="content-wrapper">
          <div className="row">
            <div className="col-lg-3 col-md-12 col-sm-12 col-12 report">
              <h1 className='pageHead mt-2'>Reports </h1>
            </div>
            ...
            <div className="col-lg-9 col-md-8 col-sm-8 col-8 tableSearchBlock">
              ...
              <div className='col-4 selectStatus'>
                <div className="form-group">
                  <select className="form-select" id="statusSearch" onChange={(e) => setStatuss(e.target.value)}>
              ...
              <div className='col-4 selectStatus'>
                <div className="form-group">
                  <select className="form-select" id="loanstatus" onChange={(e) => setLoanstatus(e.target.value)}>
              ...
              <div class="col-4 searchbtn">
                <button class="btn btn-primary me-2" onClick={searchCollectionDetail}><i class="fa-solid fa-magnifying-glass" id="Collect" ></i></button>
                ...
                <table>
                  <thead>
                    <tr>
                      ...
                      {/* <th class="border-top-0">No of Loans</th> */}
                    </tr>
                  </thead>
                  <tbody>
                    {cmlist.length > 0 ? (
                      cmlist.map((cmlist, index) => (
                        <tr>
                          ...
                          <td>{cmlist.loancreated}</td>
                          <td>{cmlist.customer_name}</td>
                          <td>{cmlist.customer_phone}</td>
                          <td>{cmlist.weeklyinstallmentnumber}</td>
                          <td>{cmlist.loan_amount}</td>
                          <td>{cmlist.status == "New" ? <span className='text-color-blue'> New </span> : cmlist.status == "Overdue" ? <span className='text-color-orange'>Overdue</span> : cmlist.status == "Active" ? <span className='text-color-green'> Active </span> : cmlist.status == "Deleted" ? <span className='text-color-red'> Deleted </span> : <span className='text-color-red'>Closed</span>}</td>
                        </tr>
                      ))
                    ) : (
                      <tr>
